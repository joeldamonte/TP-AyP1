...
public class App {
	public static void main(String[] args) {
		...
		SnakeEGLHUCG myBrain = new SnakeEGLHUCG();
		SnakeEGLHUCG myBrain2 = new SnakeEGLHUCG();
		SnakeEGLHUCG myBrain3 = new SnakeEGLHUCG();
		SnakeEGLHUCG[] ls = {myBrain,myBrain2, myBrain3};
